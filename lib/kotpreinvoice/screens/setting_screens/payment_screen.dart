          ...
          Positioned(
            ...
            child: Consumer<UpiProviderDine>(
              builder: (context, upiProvider, child) {
                debugPrint(
                  '🔄 Consumer rebuilding with UPI state: ${upiProvider.isUpiEnabled}',
                );
                return Row(
                  children: [
                    const Text(
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        debugPrint(
                          '🟢 Current UPI State before toggle: ${upiProvider.isUpiEnabled}',
                        );
                        upiProvider.toggleUpi(
                          webSocketService: webSocketService,
                        );
                        debugPrint(
                          '🟣 Toggle requested, waiting for confirmation from server...',
                        );
                      },
                      child: Container(
                        width: 60,
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: upiProvider.isUpiEnabled
                              ? Colors.blue
                              : Colors.grey[400],
                        ),
                        child: AnimatedAlign(
                          duration: const Duration(milliseconds: 200),
                          alignment: upiProvider.isUpiEnabled
