...
import 'package:yenposapp/screens/sales_order/screens/all_orders_page/discount_service.dart'
    as globaldiscount;
...
//from kot payment variable
  ...
  void _updateBalance() {
    setState(() {
      final cash = double.tryParse(_cashController.text.isNotEmpty
              ? _cashController.text
              : _customCashController.text) ??
          0;
      final upi = double.tryParse(_upiController.text.isNotEmpty
              ? _upiController.text
              : _customUpiController.text) ??
          0;
      final card = double.tryParse(_cardController.text.isNotEmpty
            ...
            child: TextField(
              ...
              onTap: () {
                ActiveField.activate(
                    ctrl: controller, node: focus, numeric: true);
              },
            ),
          ),
        ],
