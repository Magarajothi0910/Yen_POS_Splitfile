...
import 'package:yen_pos/Mode_page/bottomNavigation_Regular_Page/widgets/bottom_navigaton_bar_for_expressMode.dart';
...
import 'package:yen_pos/more_page/screen/cash_management_screen.dart';
import 'package:yen_pos/more_page/screen/wifi_ip_list.dart';
import 'package:yen_pos/more_page/widgets/configuration.dart';
import 'package:yen_pos/more_page/widgets/device_configuration.dart';
import 'package:yen_pos/more_page/widgets/logout.dart';
...
//           totalSalesOrderAdvanceCash = (data['totalSalesOrderAdvanceCash'] ?? 0)
//               .toDouble();
...
//                 'systemOpeningBalance': filteredData[0]['systemOpeningBalance']
//                     .toString(),
//                 'manualOpeningBalance': filteredData[0]['manualOpeningBalance']
//                     .toString(),
//                 'systemClosingBalance': filteredData[0]['systemClosingBalance']
//                     .toString(),
//                 'manualClosingBalance': filteredData[0]['manualClosingBalance']
//                     .toString(),
...
//       "closingDifferenceType": difference == 0
//           ? "no difference"
...
//           "shiftOpeningBalances": shiftDetails
//               .map((e) => e['openingBalance'])
//               .toList(),
//           "shiftSystemClosingBalances": shiftDetails
//               .map((e) => e['systemClosingBalance'])
//               .toList(),
//           "shiftManualClosingBalances": shiftDetails
//               .map((e) => e['manualClosingBalance'])
//               .toList(),
//           "shiftDifferenceAmounts": shiftDetails
//               .map((e) => e['differenceAmount'])
//               .toList(),
//           "shiftDifferenceTypes": shiftDetails
//               .map((e) => e['differenceType'])
//               .toList(),
...
//           "shiftOpeningDate": shiftDetails
//               .map((e) => e['openingDate'])
//               .toList(),
//           "shiftOpeningTime": shiftDetails
//               .map((e) => e['openingTime'])
//               .toList(),
//           "shiftClosingDate": shiftDetails
//               .map((e) => e['closingDate'])
//               .toList(),
//           "shiftClosingTime": shiftDetails
//               .map((e) => e['closingTime'])
//               .toList(),
//         };
...
class _MorePageState extends State<MorePage> {
  String selectedOption = 'Configuration';
