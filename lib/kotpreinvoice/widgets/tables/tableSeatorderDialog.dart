...
//                                 debugPrint("order full data is $order");
//                                 try {
//                                   return Card(
//                                     color: Colors.white,
...
//   //                     //           );
//   //                     //         } else {
//   //                     //           final qtywiseCancelData = [
//   //                     //             {
//   //                     //               'table': order['table'],
//   //                     //               'seat': order['seat'],
//   //                     //               'itemNames': [order['itemNames'][i]],
//   //                     //               'varianceNames': [
...
//   //                               right: 40,
//   //                               child: Icon(
//   //                                 Icons.hourglass_top, // pending icon
//   //                                 size: 15,
//   //                                 color: Colors.orange,
//   //                               ),
//   //                             ),
...
//   //   }) {
//   //     final box = Hive.box('approvelOrdersKOT');
...
//   //       if (data['cancelType'] != 'itemCancel') continue;
//   //       if (data['tableNumber'] != tableNumber) continue;
//   //       if (data['seat'] != seat) continue;

//   //       final List codes = data['varianceitemCode'] ?? [];

//   //       if (codes.contains(varianceCode)) {
//   //         return data['status']; // pending / approved / declined
//   //       }
//   //     }
//   //     return null;
//   //   }

//   //   String? getItemCancelRemark({
//   //     required String tableNumber,
//   //     required String seat,
//   //     required String varianceCode,
//   //   }) {
...
//   //       if (codes.contains(varianceCode)) {
//   //         return data['remark']; // pending / approved / declined
//   //       }
//   //     }
//   //     return null;
//   //   }
...
//   //             try {
//   //               final String itemName = items[i];
//   //               final String varianceCode = order['varianceitemCodes'][i];

//   //               // 🔥 READ STATUS FROM HIVE
//   //               final String? hiveStatus = getItemCancelStatus(
//   //                 tableNumber: tableNumber,
//   //                 seat: seat,
//   //                 varianceCode: varianceCode,
//   //               );
//   //               final String? hiveRemark = getItemCancelRemark(
//   //                 tableNumber: tableNumber,
//   //                 seat: seat,
//   //                 varianceCode: varianceCode,
//   //               );
...
//   //                             //                 order['varianceNames'][i],
//   //                             //               ],
//   //                             //               'varianceitemCodes': [varianceCode],
//   //                             //               'prices': [order['prices'][i]],
//   //                             //               'weights': [order['weights'][i]],
//   //                             //               'quantities': [
//   //                             //                 order['quantities'][i],
...
//   //     );
//   //   } catch (e) {
//   //     debugPrint("❌ buildOrderDetails error => $e");
//   //     return const SizedBox.shrink();
//   //   }
//   // }
//   static Widget buildOrderDetails({
...
//       valueListenable: Hive.box('approvelOrdersKOT').listenable(),
//       builder: (context, box, _) {
//         /// -------- ITEM STATUS FROM HIVE ----------
//         String? getItemCancelStatus(String varianceCode) {
//           for (final raw in box.values) {
//             if (raw is! Map) continue;
...
//             // 2️⃣ collect variance codes from BOTH schemas
//             List<String> codes = [];

//             // NEW FORMAT → orders.varianceitemCodes
//             final orders = data['orders'];
//             if (orders is Map && orders['varianceitemCodes'] is List) {
//               codes = (orders['varianceitemCodes'] as List)
//                   .map((e) => e.toString())
//                   .toList();
//             }
//             // OLD FORMAT → varianceitemCode
//             else if (data['varianceitemCode'] is List) {
//               codes = (data['varianceitemCode'] as List)
//                   .map((e) => e.toString())
//                   .toList();
//             }
...
//         String? getItemCancelRemark(String varianceCode) {
//           for (final raw in box.values) {
//             if (raw is! Map) continue;
...
//                 final String? hiveStatus = getItemCancelStatus(varianceCode);

//                 debugPrint("hiveStatus is $hiveStatus");
//                 final String? hiveRemark = getItemCancelRemark(varianceCode);
...
//                 final double amount = amounts[i].toDouble();
//                 final double price = prices[i].toDouble();
//                 final String uom = uoms[i];
//                 final double weight = weights[i].toDouble();
...
//                                 //     );
//                                 //   }
//                                 //   if (hiveStatus == 'declined') {
//                                 //     WidgetsBinding.instance.addPostFrameCallback((
//                                 //       _,
//                                 //     ) {
//                                 //       showCustomFlushbar(
//                                 //         context,
//                                 //         'Item cancellation was declined by management.',
//                                 //         type: FlushbarType.error,
//                                 //       );
//                                 //     });
//                                 //     return;
//                                 //   }
//                                 //   if (hiveStatus == 'approved') {
//                                 //     await _cancelSingleItem(
//                                 //       context: context,
//                                 //       order: order,
//                                 //       itemIndex: i,
...
class SeatOrderDetailsDialog {
                        ...
                        return TextField(
                          ...
                          onChanged: (value) {
                            ...
                            if (value.isEmpty) {
                              ...
                              cancelQtyController.text = currentQty.toString();
                              cancelQtyController.selection =
                                  TextSelection.collapsed(
                                    offset: cancelQtyController.text.length,
                                  );
                              qtyError = 'Max available: $currentQty';
                              isQtyValid = false;
                            } else {
  ...
  static Future<void> _reverseSingleItem({
    ...
    debugPrint("order data is => $order");
    debugPrint("itemIndex data is => $itemIndex");

    try {
      final TextEditingController revertQtyController = TextEditingController();

      debugPrint("🔄 Starting reverse cancellation for index: $itemIndex");
      ...
      final List<dynamic> cancelledQtyDyn = order['cancelledQty'] ?? [];
      final List<dynamic> pricesDyn = order['prices'] ?? [];
      final List<dynamic> amountsDyn = order['amounts'] ?? [];

      debugPrint("quantitiesDyn data is => $quantitiesDyn");
      debugPrint("weightsDyn data is => $weightsDyn");
      debugPrint("varianceNames data is => $varianceNames");
      debugPrint("cancelledQtyDyn data is => $cancelledQtyDyn");
      debugPrint("pricesDyn data is => $pricesDyn");
      debugPrint("amountsDyn data is => $amountsDyn");
      ...
      final List<double> amountsList = amountsDyn
          .map((e) => (e as num).toDouble())
          .toList();

      final double currentCancelledQty = cancelledQtyList[itemIndex];
      debugPrint("currentCancelledQty data is => $currentCancelledQty");

      if (currentCancelledQty <= 0) return;

      // === MAX QTY ===
      final int maxQty = currentCancelledQty.toInt();
      debugPrint("maxQty data is => $maxQty");

      revertQtyController.text = maxQty.toString();
      debugPrint(
        "revertQtyController.text data is => ${revertQtyController.text}",
      );
          ...
          await showDialog<bool>(
            ...
            builder: (_) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text(
                    'Item: ${varianceNames[itemIndex]}\n'
                    'Cancelled Qty: $currentCancelledQty',
                  ),
                  const SizedBox(height: 12),
                  TextField(
                    controller: revertQtyController,
                    keyboardType: TextInputType.number,
                    inputFormatters: [
                      FilteringTextInputFormatter.digitsOnly,
                      TextInputFormatter.withFunction((oldValue, newValue) {
                        ...
                        if (value > maxQty) return oldValue;
                        return newValue;
                      }),
                    ],
                    decoration: const InputDecoration(
                      labelText: 'Revert Quantity',
      ...
      // === 3. QTY-WISE REVERT ===
      final int revertQty = int.tryParse(revertQtyController.text.trim()) ?? 0;
      debugPrint("revertQty data is => $revertQty");

      if (revertQty <= 0 || revertQty > currentCancelledQty) return;

      cancelledQtyList[itemIndex] = currentCancelledQty - revertQty;
      debugPrint(
        "cancelledQtyList[itemIndex] data is => ${cancelledQtyList[itemIndex]}",
      );

      quantitiesList[itemIndex] = quantitiesList[itemIndex] + revertQty;
      debugPrint(
        "quantitiesList[itemIndex] data is => ${quantitiesList[itemIndex]}",
      );

      // === 4. UPDATE AMOUNT (CRITICAL FIX) ===
      final double price = pricesList[itemIndex];
      final double weight = (itemIndex < weightsDyn.length)
          ? (weightsDyn[itemIndex] as num).toDouble()
          : 0.0;

      final double updatedQty = quantitiesList[itemIndex];

      final double newAmount = (weight > 0)
          ? price * weight * updatedQty
          : price * updatedQty;

      debugPrint("newAmount data is $newAmount");

      if (itemIndex < amountsList.length) {
        amountsList[itemIndex] = newAmount;
        debugPrint("✅ Corrected amountsList[itemIndex] => $newAmount");
      }

      // === 5. CONFIG QTY (REBUILD – FIXED) ===
      if (order['config'] is List && itemIndex < order['config'].length) {
        final configItem = order['config'][itemIndex];
        debugPrint("configItem BEFORE => $configItem");

        final List<dynamic> configQty = List<dynamic>.from(
          configItem['configQty'] ?? [],
        );

        final int qty = quantitiesList[itemIndex].toInt();
        debugPrint("Rebuilding configQty from qty => $qty");

        for (int i = 0; i < configQty.length; i++) {
          configQty[i] = i < qty ? 1 : 0;
        }

        configItem['configQty'] = configQty;

        debugPrint("configItem AFTER => ${configItem['configQty']}");
      }
      ...
      for (int i = 0; i < quantitiesList.length; i++) {
        final double qty = quantitiesList[i];
        final double pr = pricesList[i];
        final double wt = (i < weightsDyn.length)
            ? (weightsDyn[i] as num).toDouble()
            : 0.0;

        if (qty <= 0) continue;
        newTotal += (wt > 0) ? pr * wt * qty : pr * qty;
      }
      ...
      order['quantities'] = quantitiesList;
      order['cancelledQty'] = cancelledQtyList;
      order['amounts'] = amountsList;
      order['totalAmount'] = newTotal;
      order['partiallycancelled'] = stillPartiallyCancelled;

      if (order['itemRemark'] is List) {
        final remarks = List<dynamic>.from(order['itemRemark']);
        while (remarks.length <= itemIndex) {
          remarks.add('');
        }
        remarks[itemIndex] = '';
        order['itemRemark'] = remarks;
      }
      ...
      final Map<String, dynamic> dataToSend = {
        'action': 'reverseCancelOrderItem',
        'hiveOrderId': order['hiveOrderId'],
        'varianceName': varianceNames[itemIndex],
        'varianceItemCode': varianceItemCodes[itemIndex],
        'uom': uoms[itemIndex],
        'weight': weights[itemIndex],
        'updatedIndex': itemIndex,
        ...
        'updatedQuantity': quantitiesList[itemIndex],
        'updatedCancelledQty': cancelledQtyList[itemIndex],
        'updatedAmount': amountsList[itemIndex],
        'totalAmount': newTotal,
        'partiallycancelled': stillPartiallyCancelled,
        'ipAddress': printerIp,
      };
      debugPrint("dataToSend is => $dataToSend ");
      ...
      debugPrint("💥 Error in _reverseSingleItem: $e\n$stack");
    }
  }
                ...
                return Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (isPartiallyCancelled || isFullyCancelled)
                              Text(
                                "Cancelled: $cancelledQty / $totalQty",
                                style: const TextStyle(
                                  fontSize: 12,
                      ...
                      Expanded(
                        child: Center(
                          child: status == "active" && remainingQty != 0
                              ? Stack(
                                  clipBehavior: Clip.none,
                                  children: [
                                    IconButton(
                      ...
                      Expanded(
                        child: Center(
                          child:
                              ((status == "active" && isPartiallyCancelled) ||
                                  isFullyCancelled)
                              ? IconButton(
                                  icon: const Icon(
                                    Icons.undo,
