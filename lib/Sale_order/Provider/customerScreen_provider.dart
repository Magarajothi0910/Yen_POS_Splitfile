...
import 'package:yenposapp/Global/Model/branch_model.dart';
...
import 'package:yenposapp/Sale_order/Models/approval_order_model.dart';
import 'package:yenposapp/Sale_order/Models/held_order_model.dart';
import 'package:yenposapp/Sale_order/Models/sale_order_model.dart';
import 'package:yenposapp/Sale_order/Models/sales_invoicemodel.dart';
...
import 'package:yenposapp/Sale_order/Print_Receipt/salesOrder_print.dart';
import 'package:yenposapp/Sale_order/Print_Receipt/so_placeorder_payment_print.dart';
...
import 'package:yenposapp/Sale_order/Provider/saveAudioandImageFile.dart';
import 'package:yenposapp/Sale_order/Widgets/storetype_selection_dialogue.dart';
...
class CustomerScreenProvider with ChangeNotifier {
  ...
  Future<void> _patchHoldOrderStatus(String? holdOrderId) async {
    ...
    try {
      ...
      final response = await http.patch(
        Uri.parse(
          "https://yenerp.com/fastapi/heldorders/$holdOrderId",
        ), // Use holdOrderId in the URL
        headers: {'Content-Type': 'application/json'},
