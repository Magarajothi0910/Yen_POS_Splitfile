...
import 'package:yen_pos/kotpreinvoice/components/time_formater.dart';
import 'package:yen_pos/kotpreinvoice/handlers/syncMissingExtraTablesFromOrders.dart';
import 'package:yen_pos/kotpreinvoice/screens/viewtocart.dart';
...
class _TableScreenState extends State<TableScreen> {
  ...
  late GlobalDataManager _GlobalData;
  ...
  void initState() {
    ...
    //   debugPrint('data of the table is ${orderValue['table']}');
    ...
    _GlobalData = Provider.of<GlobalDataManager>(context, listen: false);

    final salesTypes = _GlobalData.branches;
  ...
  Widget _buildTableGrid(
    ...
    return Consumer2<HoldOrderProvider, OrderProvider>(
      builder: (context, holdOrderProvider, orderProvider, child) {
                                          ...
                                          return GestureDetector(
                                            onLongPress: () async {
                                              ...
                                              try {
                                                ...
                                                debugPrint(
                                                  "currecttable is $currentTable",
                                                );
                                                debugPrint(
                                                  "resolvedSeat is $resolvedSeat",
                                                );
                                                final runningOrders =
                                                    orderProvider
                                            ...
                                            onTapUp: (details) async {
                                              if (!_scrollController
                                                ...
                                                try {
                                                  ...
                                                  debugPrint(
                                                    "holdOrder of true or false $holdOrder",
                                                  );
                                                  if (holdOrder != null) {
                                                    holdOrder.forEach((
                                                      key,
                                                      ...
                                                      debugPrint(
                                                        "value of holdorder are $value",
                                                      );
                                                      cartProvider.cart[key] =
                                                          value;
                                                    });
                                                    debugPrint(
                                                      "✅ Hold order loaded for table $tableNumber seat $seat",
                                                    );
                                                  } else {
                                                    debugPrint(
