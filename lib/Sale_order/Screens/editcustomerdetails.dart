...
import 'package:yen_pos/Sale_order/Screens/edit_customerr_dropdown.dart';
import 'package:yen_pos/Sale_order/Widgets/customcharge_keybaord.dart';
import 'package:yen_pos/Sale_order/Widgets/date_handler.dart';
...
class _EditCustomerDetailsState extends State<EditCustomerDetails> {
  ...
  void _populateFields() {
    ...
    customerScreenProvider.customChargeControllers.forEach(
      (key, controller) {},
    );
  }
