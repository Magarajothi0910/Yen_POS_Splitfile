...
class _productCardViewListState extends State<productCardViewList> {
  ...
  Future<void> _processOrder(String phoneNumber) async {
    ...
    try {
      ...
      for (var entry in cartProvider.cart.entries) {
        debugPrint("Processing cart entry: $entry");
        ...
        try {
          ...
          bool isByWeight = uom == 'kgs' || uom == 'kg';
          ...
          debugPrint(
            ...
            "| UoM: $uom | Qty: $quantity | Weight: ${weightKg.toStringAsFixed(3)} kg "
            "| Unit ₹${unitPrice.toStringAsFixed(2)} | "
            "Base: ₹${baseItemPrice.toStringAsFixed(2)} | "
            "Addons: ₹${addOnsTotalThisItem.toStringAsFixed(2)} | "
  ...
  Widget build(BuildContext context) {
    ...
    void handleSubmit(BuildContext context, cartProvider, printerProvider) {
      ...
      //   debugPrint("orders are ::: ${order.toString()}");
      //   return order;
      // }).toList();
      ...
      try {
        ...
        try {
          cartProvider.cart.forEach((productId, cartItem) {
            print("cartItem qty: ${cartItem['qty']}");
            ...
            print("displayStock for $productId: $displayStock");
            ...
            stockCheckList.add({
              'item': productId, // Use real item name if available
                  ...
                  Expanded(
                    child: Consumer<CartProviderKOT>(
                      builder: (context, cartProvider, child) {
                        ...
                        debugPrint("cartEntries is : $cartEntries");
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            debugPrint("cartItem is : $cartItem");
