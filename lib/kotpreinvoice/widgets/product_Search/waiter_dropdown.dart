...
Widget buildWaiterDropdown(
  ...
  return Consumer<EmployeeProvider>(
    builder: (context, employeeProvider, _) {
      ...
      final List<DropdownMenuItem<String>> dropdownItems = employeeProvider.employees.map((employee) {
      ...
      return DropdownButtonHideUnderline(
        child: DropdownButton2<String>(
          isExpanded: true,
          value: (employeeProvider.selectedWaiter != null && employeeProvider.selectedWaiter!.isNotEmpty) ? employeeProvider.selectedWaiter : null,
          onChanged: (String? value) {
            if (value != null) {
              employeeProvider.setSelectedWaiter(value); // 👤 Update EmployeeProvider
