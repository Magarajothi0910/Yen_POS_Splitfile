      ...
      children: [
        SizedBox(
          ...
          child: TextFormField(
            ...
            // onChanged: (value) {
            //   // ✅ if user pastes, strip non-digits and enforce 5 limit
            //   final filtered = value.replaceAll(RegExp(r'[^0-9]'), '');
            //   final limited =
            //       filtered.length > 5 ? filtered.substring(0, 5) : filtered;

            //   if (limited != value) {
            //     cartProvider.customChargeController.text = limited;
            //     cartProvider.customChargeController.selection =
