...
import 'package:yenposapp/screens/sales_order/screens/create_salesOrder.dart/numeric_Calculator.dart';

import 'package:yenposapp/server/Service/sync_service.dart';
import 'package:yenposapp/services/branchwise_item_fetch.dart';

import '../../../Global/customd_keyboard.dart';
...
//     denominationTotals.value = newTotals;
//     CashManagementProvider.denominationCounts.value = newCounts;
//     CashManagementProvider.physicalCashSales.value =
//         newTotals.values.fold(0, (sum, total) => sum + total);
//   }
...
//     // Removed _clearControllers() to prevent clearing on Save
//     Navigator.pop(context);
//   }
...
// Widget buildShiftClosingContainer(BuildContext context,
...
//                   child: _buildShiftClosingButton(context, connectivityResult),
//                 ),
//               ],
//             ),
//           ),
...
//                   "UPI Sales", CashManagementProvider.upiSalesController),
//               _buildSummaryRowWithManual(
//                   "Card Sales", CashManagementProvider.cardSalesController),
...
//   String title,
//   ValueNotifier<String> manualController,
// ) {
//   return Padding(
//     padding: const EdgeInsets.only(left: 20, top: 10),
//     child: Row(
...
//                         manualController.value = value.toStringAsFixed(2);
//                       },
//                     ),
//                   );
//                 },
...
//                             invoiceData =
//                                 jsonDecode(invoiceData) as Map<String, dynamic>;
//                           }
...
//                           await syncService.syncUnsyncedInvoices(itemProvider);
//                         }
...
class _ShiftClosingContainerState extends State<ShiftClosingContainer> {
  ...
  Widget _buildSummaryColumns(
      context, ValueNotifier<ConnectivityResult> connectivityResult) {
    return ValueListenableBuilder<int>(
      valueListenable: CashManagementProvider.physicalCashSales,
      builder: (context, denominationTotal, _) {
        return ValueListenableBuilder<int>(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: _buildShiftClosingButton(
                              context, connectivityResult, soApprovalStatus),
                        ),
                      ],
                    ),
                  ),
                  ...
                  onPressed: isConnected && !_isProcessing
                      ? () async {
                          ...
                          try {
                            ...
                            var invoiceBox = await Hive.openBox('invoicesBox');
                            bool needsSync =
                                invoiceBox.values.any((invoiceData) {
                              if (invoiceData is String) {
