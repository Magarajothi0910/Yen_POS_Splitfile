...
import '../kotproviders/pax_provider.dart';
...
class productCardViewList extends StatefulWidget {
  ...
  final String seat;
  final Function onSubmit; // Accepts phone number
  ...
  Widget build(BuildContext context) {
    ...
    void handleSubmit(BuildContext context, cartProvider, printerProvider) {
      ...
      if (!hasOverallPrinter || missingItemIps.isNotEmpty) {
        ...
        widget.onSubmit(customerPhoneNumber);
        Provider.of<PaxProvider>(context, listen: false)
            .resetPax(); // Reset Pax after submission
      }
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          mainAxisAlignment:
              MainAxisAlignment.start, // Align title and icon to the left
          children: [
            Text(
              'Your cart for ${widget.tableNumber} - ${widget.seat}',
            ...
            const SizedBox(width: 10), // Space between title and icon
            ...
            GestureDetector(
              onTap: () {
                showInitialPopup(
                  ...
                  initialPhoneNumber:
                      customerPhoneNumber, // ✅ Pass the saved phone number
                );
              },
              child: Stack(
                ...
                children: [
                  const Icon(
                    Icons.account_circle, // Human user icon
                    size: 30,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(
                        color: Colors.green, // Background color for phone icon
                        shape: BoxShape.circle,
                      ),
                      child: const Icon(
                        Icons.phone, // Phone icon overlay
                        size: 12,
                        color: Colors
                            .white, // White phone icon on green background
                      ),
                    ),
                  ),
                ],
              ...
              child: Column(
                children: [
                  if (cartProvider.cart.isNotEmpty)
                    Row(
                      children: [
                        buildPaxDropdown(context),
                        const SizedBox(
                          width: 10,
                        ),
                        Expanded(flex: 3, child: buildWaiterDropdown(context)),
                      ],
                    ), //pax_dropdown.dart
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final productId =
                            cartProvider.cart.keys.toList()[index];
                        ...
                        List<List<String>> addons = List.generate(
                            quantity,
                            (i) => List.from(cartProvider.cart[productId]
                                            ['addons'] !=
                                        null &&
                                    cartProvider
                                            .cart[productId]['addons'].length >
                                        i
                        ...
                        List<String> variants = List.generate(
                            quantity,
                            (i) => cartProvider.cart[productId]['variants'] !=
                                        null &&
...
// Initialize states after syncing
                        ...
                        List<TextEditingController> remarkControllers =
                          ...
                          (i) => TextEditingController(
                            text:
                                cartProvider.getRemarks(productId, quantity)[i],
                          ),
                        );
                        ...
                        return Dismissible(
                          ...
                          onDismissed: (direction) {
                            cartProvider.removeFromCart(context, productId,
                        ...
                        //       .shrink(); // Hide items with quantity 0
                        // }
                      },
                    ),
                  ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              ...
                              cartProvider.cart.forEach((productId, cartItem) {
                                ...
                                final isWeight = product.variance_Uom
                                            .toLowerCase() ==
                                        "kg" ||
                                    product.variance_Uom.toLowerCase() == "kgs";
                          ...
                          ElevatedButton(
                            onPressed: () {
                              handleSubmit(
                                  context, cartProvider, printerProvider);
                            },
                            style: ElevatedButton.styleFrom(
