...
import 'package:yenposapp/Sale_order/Screens/all_orders.dart';
import 'package:yenposapp/Sale_order/Screens/edit_customerr_dropdown.dart';
import 'package:yenposapp/Sale_order/Screens/editsalesperson_dropdown.dart';
import 'package:yenposapp/Sale_order/Widgets/image-picker-widget.dart';
import 'package:yenposapp/Sale_order/Widgets/photoScreen.dart';
import 'package:yenposapp/Sale_order/Widgets/voice_recording.dart';
...
class EditOutletCustomerDetails extends StatefulWidget {
  final SalesOrderDisplay? selectedOrder;
  final bool isEditing;
  final String? orderType;
  final GlobalKey keyboardKey;
  const EditOutletCustomerDetails(
      {super.key,
      this.selectedOrder,
  ...
  @override
  _EditOutletCustomerDetailsState createState() =>
      _EditOutletCustomerDetailsState();
}

class _EditOutletCustomerDetailsState extends State<EditOutletCustomerDetails> {
  ...
  final int _selectedRadioValue = 0; // The selected radio button value
  ...
  @override
  void didUpdateWidget(EditOutletCustomerDetails oldWidget) {
  ...
  void _populateFields() {
    ...
    // Ensure selectedOrder is not null before populating fields
    if (widget.selectedOrder != null) {
      

      String deliveryDate = widget.selectedOrder!.deliveryDate;

      // Set the formatted or raw date
      ...
      if (widget.selectedOrder?.eventDate != null &&
        ...
        try {
          ...
          formattedEventDate = ""; // If parsing fails, show an empty field
        }
      }
      customerScreenProvider.birthdaydateController.text = formattedEventDate;
      // widget.selectedOrder!.deliveryDate ?? '';
