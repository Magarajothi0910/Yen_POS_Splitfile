...
//   //     qty: List<int>.from(json['qty'] ?? 0),
//   //     tax: List<int>.from(json['tax'] ?? 0),
//   //     uom: List<String>.from(json['uom'] ?? ''),
//   //     amount: List<double>.from(json['amount'] ?? 0.0),
//   //     price: List<int>.from(json['price'] ?? 0),
//   //     weight: List<double>.from(json['weight'] ?? 0.0),
