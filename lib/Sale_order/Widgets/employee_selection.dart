              ...
              decoration: InputDecoration(
                ...
                prefixIcon: IconButton(
                  icon: Icon(
                    ...
                    color: _isQrMode ? Colors.green : Colors.blue,
                  ),
                  onPressed: _toggleQrMode,
                ),

                // ❌ Clear icon in SUFFIX (show only if text exists)
                suffixIcon:
                    customerScreenProvider.searchController.text.isNotEmpty
                    ? IconButton(
                        icon: const Icon(Icons.clear),
                        onPressed: () {
                          setState(() {
                            customerScreenProvider.searchController.clear();
                            _removeOverlay(); // optional
                          });
                        },
                      )
                    : null,
