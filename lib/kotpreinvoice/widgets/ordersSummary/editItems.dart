        ...
        child: Scrollbar(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: List.generate(widget.order[widget.i]['configQty'].length, (
                index,
              ) {
                // Extract data for each quantity row
                List<String> addons = List<String>.from(
                  widget.order[widget.i]['addOn'][index],
                );
                List<int> addonquantity = List<int>.from(
                  widget.order[widget.i]['addOnQuantity'][index],
                );
                ...
                ValueNotifier<bool> isParcelNotifier = ValueNotifier<bool>(
                  type == "Parcel",
                );
                ValueNotifier<bool> toggleRemarkNotifier = ValueNotifier<bool>(
                  remark.isNotEmpty,
                );
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            try {
              ...
              String seathiveOrderId = widget
                  .order['seathiveOrderId']; // Assuming this is part of the `order`
