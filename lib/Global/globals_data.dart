...
// App types
const String APP_SERVER = 'server';
const String APP_CLIENT = 'client';
const String app = 'POS';

// Global ValueNotifier
ValueNotifier<String> appTypeNotifier = ValueNotifier<String>('');

// Optional getter (clean usage)
String get appType => appTypeNotifier.value;
...
final ValueNotifier<String> ip = ValueNotifier<String>('');
...
ValueNotifier<bool> isDineInEnabled = ValueNotifier<bool>(true);
