...
import 'package:yenposapp/Global/globals_data.dart' as webSocketglobals;
...
class EditCustomerScreenProvider with ChangeNotifier {
  ...
  void addItemToOrder(Map<String, dynamic> item, double weightOrQuantity) {
    ...
    if (existingIndex != -1) {
      ...
      double updatedAmount = unitPrice *
          (isKgUnit
  ...
  void updateItemInOrder(
    ...
    if (increasedIndex != -1 && newModificationValue > 0) {
      ...
      existingItem[isKgUnit ? 'weight' : 'quantity'] =
          isKgUnit ? newModificationValue : newModificationValue;
