...
class CustomerScreenProvider with ChangeNotifier {
  ...
  Future<void> postCreditCustomer(
    ...
    List<String> varianceNames = globals.cartItems
        .map((item) => item.varianceName)
        .toList();
    List<double> quantities = globals.cartItems
    ...
    List<String> uoms = globals.cartItems
        .map((item) => item.uom.toString())
        .toList();
    List<double> taxs = globals.cartItems
        .map((item) => item.tax.toDouble())
        .toList();
    List<double> weights = globals.cartItems
        .map((item) => item.weight)
        .toList();
    List<double> prices = globals.cartItems
        .map((item) => item.pricePerKg.toDouble())
        .toList();
