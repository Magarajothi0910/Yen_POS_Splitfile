          ...
          Container(
            ...
            child: ListView(
              children: [
                ...
                _buildSettingTile('Device Configrations', onTap: () {
                  setState(() {
                    selectedOption = 'Device Configrations';
                    cashManagementView = 'Shift Closing';
                  });
                }),
                _buildSettingTile('LogOut', onTap: () {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => Scaffold(
          ...
          body: const Center(
            child: Text('Device Name is Pos 1'),
          ),
        ),
      ),
    );
...
Future<void> _postCustomerData(
  ...
  if (response.statusCode == 200) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Customer successfully added!')),
    );
  } else {
    ScaffoldMessenger.of(context).showSnackBar(
