...
// class seatScreen1 extends StatefulWidget {
...
// class _seatScreenState extends State<seatScreen1> {
//   @override
//   void initState() {
//     super.initState();
...
//     print("sendseatActionToServer.....33");
...
//     print("getActiveOrdersForSeat $ordersForSeat");
//     // Log for debugging
//     print("Selected Seat: $seat ${widget.tableNumber}");
//     print("Seat Order ID (seathiveOrderId): $seathiveOrderId");

//     // Debug print for selected table seat order
//     for (var order in ordersForSeat) {
//       print(
//           "Order for Seat: ${order['seat']} Table: ${order['table']} - Status: ${order['status']}");
//     }
...
//     final holdOrder = holdOrderProvider.loadHoldOrder(widget.tableNumber);
...
//       });
//       print("Loaded hold order for Table ${widget.tableNumber} - Seat $seat");
//     } else {
//       print("No hold order for Table ${widget.tableNumber} - Seat $seat");
//     }
//     Navigator.push(
//       context,
//       MaterialPageRoute(
...
//     };
//     webSocketService.channel.sink.add(jsonEncode(data));
//     print("sendTransferSeatActionToServer $seathiveOrderId$data");
//   }
...
//                                   .hasHoldOrder(widget.tableNumber);

//                               final ordersForSeat = orderProvider
//                                   .getRunningOrdersForSeat(widget.tableNumber);
//                               print("ordersForSeat1 $ordersForSeat");
...
//                               bool isSeatBooked = Provider.of<WebSocketService>(
//                                       context,
//                                       listen: false)
//                                   .receivedActions
//                                   .any((action) =>
...
//                               print("isSeatBooked  $isSeatBooked");
...
//                                   print("hasValidAddOns....  $hasValidAddOns");
...
//                                 .getPreInvoicePrinterIp();
//                         if (printerIp == null) {
//                           print("PreInvoice printer IP not set.");
...
//         print(
//             "patchOrderStatusBySeathiveOrderId ${order['seathiveOrderId']} updated to confirm");
//       } else {
//         print("Skipping order: Missing or invalid seathiveOrderId");
//       }
//     }
//   }
...
//                   Navigator.of(context).pop(); // Close the dialog
//                 } catch (e) {
//                   print("Error generating pre-invoice: $e");
...
//                       print("_showPreInvoiceConfirmation $seatOrders");
//                     } else {
//                       Flushbar(
//                         message: "Already Pre-Invoice generated..",
//                         duration: const Duration(seconds: 2),
