...
import 'package:yen_pos/Global/Widget/glassmorphisom.dart';
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () async {
                                // final globalManager = Provider.of<GlobalDataManager>(context,listen: false);
                                ...
                                //     context,
                                //     "Item '${variance.varianceName}' is out of stock",
                                //     backgroundColor: Colors.redAccent,
                                //     duration: Duration(seconds: 1),
                                //   );
                                //   // Optional: visually mark it somehow (grey out tile, etc.)
                                //   return; // ← stop here — no dialog
                                // }
                ...
                children: [
                  CustomText(
                    text:
                        ...
                        'Stock: ${displayStock.toStringAsFixed(3)}',
                    style: TextStyle(
                      fontFamily: "Poppins",
                      fontSize: 12,
                      color: isSelected
...
Future<void> _addWeightItemToCart(
  ...
  try {
    ...
    final lazyBox = await Hive.openBox('items');
    final branchData = await lazyBox.get('branchwiseItems_$locationId');
    final itemData = branchData?['data']?[itemName];
