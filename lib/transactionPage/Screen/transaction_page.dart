...
import 'package:yenposapp/Global/Widget/custom_button_reuse.dart';
...
import 'package:yenposapp/transactionPage/Model/transaction_model.dart';

import 'package:yenposapp/transactionPage/Provider/transactionProvider.dart';
import 'dart:convert';

import 'package:yenposapp/transactionPage/Screen/edit_outlet_so_customerdetails.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Future<void> postSalesReturn(List<Map<String, dynamic>> returnData) async {
    ...
    final payload = {
      ...
      "status": "sales return",
      "branch": globals.branchName, // Replace with actual branch
