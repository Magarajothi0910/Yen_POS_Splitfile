    ...
    return AlertDialog(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: List.generate(
                  widget.order[widget.i]['configQty'].length, (index) {
                // Extract data for each quantity row
                List<String> addons =
                    List<String>.from(widget.order[widget.i]['addOn'][index]);
                String selectedVariant =
                    widget.order[widget.i]['variance'][index];
                ...
                ValueNotifier<bool> isParcelNotifier =
                    ValueNotifier<bool>(type == "Parcel");
                ValueNotifier<bool> toggleRemarkNotifier =
                    ValueNotifier<bool>(remark.isNotEmpty);
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              if (quantities[widget.i] > 0 &&
                                  widget.order[widget.i]['configQty'][index] >
                                      0) {
                      ...
                      Row(
                        children: [
                          if (widget.allAddOns.isNotEmpty)
                            ...
                            //     items: widget.allAddOns, // All possible add-ons
                            ...
                            //       widget.order[widget.i]['addOn'][index] =
                            //           selectedItems;
                            //     },
                            //   ),
                            // ),
                            if (widget.order[widget.i]['variance']
                                .where((v) =>
                              ...
                              SizedBox(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  items: [
                                    ...
                                    ...widget.order[widget.i]['variance']
                                        .where((v) =>
                                            v.toString().trim().isNotEmpty)
                                        .toSet()
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            try {
              ValueNotifier<List<double>> quantitiesNotifier =
                  ValueNotifier<List<double>>(quantities);
              ValueNotifier<List<Map<String, dynamic>>> configNotifier =
                  ValueNotifier<List<Map<String, dynamic>>>(config);
              widget.order['config'] = config;
              widget.order['quantities'] =
                  quantities; // Notify the quantities field
              String seathiveOrderId = widget.order[
                  'seathiveOrderId']; // Assuming this is part of the `order`
