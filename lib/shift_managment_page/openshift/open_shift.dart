...
import 'package:yen_pos/Sale_order/Widgets/customd_keyboard.dart';
...
class _OpenShiftState extends State<OpenShift> {
  ...
  double _calculateDifference(int physicalCash) {
    return physicalCash - globals.systemOpeningCash;
  }
  ...
  Future<void> _postShiftData(int physicalCash) async {
    ...
    final payload = {
      // "shiftNumber": "1",
      "systemOpeningBalance": globals.systemOpeningCash,
    ...
    return ValueListenableBuilder<int>(
      ...
      builder: (context, physicalCash, _) {
        ...
        return Column(
          children: [
            Text(
              'Actual Opening Cash: ${globals.systemOpeningCash}',
              style: const TextStyle(
                fontFamily: 'Poppins',
                fontSize: 18,
  ...
  //                                       children: const [
  //                                         Expanded(child: Center(child: Text('Cash', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold)))),
  //                                         Expanded(child: Center(child: Text('Count', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold)))),
  //                                         Expanded(child: Center(child: Text('Total', style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.bold)))),
  //                                       ],
  //                                     ),
  //                                     const Divider(thickness: 2),
  ...
  //                                           mainAxisAlignment: MainAxisAlignment.spaceEvenly,
  //                                           children: [
  //                                             Expanded(child: Center(child: Text('$denom', style: TextStyle(fontFamily: 'Poppins', fontSize: 16)))),
  //                                             Expanded(
  //                                               child: Container(
  ...
  //                                                     fontFamily: 'Poppins',
  //                                                     fontSize: 16,
  //                                                     color: currentFocusIndex == index ? Colors.blue : Colors.black,
  //                                                   ),
  //                                                   decoration: InputDecoration(
  //                                                     isDense: true,
  //                                                     contentPadding: const EdgeInsets.symmetric(vertical: 7, horizontal: 6),
  //                                                     border: OutlineInputBorder(
  //                                                       borderSide: BorderSide(color: currentFocusIndex == index ? Colors.blue : Colors.grey, width: currentFocusIndex == index ? 2.0 : 1.0),
  //                                                     ),
  //                                                     enabledBorder: OutlineInputBorder(
  //                                                       borderSide: BorderSide(color: currentFocusIndex == index ? Colors.blue : Colors.grey, width: currentFocusIndex == index ? 2.0 : 1.0),
  //                                                     ),
  //                                                     focusedBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.blue, width: 2.0)),
  //                                                     fillColor: currentFocusIndex == index ? Colors.blue.withOpacity(0.1) : Colors.white,
  //                                                     filled: true,
  //                                                   ),
  //                                                   onTap: () {
  ...
  //                                               ),
  //                                             ),
  //                                             Expanded(child: Center(child: Text('${totals[denom] ?? 0}', style: TextStyle(fontFamily: 'Poppins', fontSize: 16, fontWeight: FontWeight.bold)))),
  //                                           ],
  //                                         ),
  //                                       );
  //                                     }).toList(),
  ...
  //                                           Text('${_calculateGrandTotal()}', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blue)),
  //                                         ],
  //                                       ),
  //                                     ),
  //                                   ],
  ...
  //                                               context: context,
  //                                               title: 'Save Denomination & Open Shift',
  //                                               content: 'Are you sure you want to Open Shift with the denomination Values?',
  //                                               confirmText: 'Yes, Open Shift',
  //                                               cancelText: 'No, Edit',
  //                                             );
  ...
  //         content: Text(content),
  //         actions: [
  //           TextButton(onPressed: () => Navigator.pop(context, false), child: Text(cancelText, style: const TextStyle(fontFamily: 'Poppins', color: Colors.blue))),
  //           TextButton(onPressed: () => Navigator.pop(context, true), child: Text(confirmText, style: const TextStyle(fontFamily: 'Poppins', color: Colors.blue))),
  //         ],
  //       ),
  //     );
  //   }
